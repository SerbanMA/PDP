...
namespace Laboratory4.server
{
    class SyncTaskMech
    {
        ...
        private static Task ConnectWrapper(HttpObject httpObject)
        {
            httpObject.clientSocket.BeginConnect(httpObject.endPoint, ConnectCallback, httpObject);

            return Task.FromResult(httpObject.connect.WaitOne());
        }
        ...
        private static Task SendWrapper(HttpObject httpObject)
        {
            ...
            return Task.FromResult(httpObject.send.WaitOne());
        }
